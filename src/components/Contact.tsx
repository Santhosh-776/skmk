...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Visit Us",
      details: ["Sri Krishna Dairy", "Main Road, Dairy Colony", "City - 123456"],
      action: "#map",
      color: "dairy-green"
    },
    {
  ...
  const socialLinks = [
    ...
    { icon: MessageCircle, name: "WhatsApp", url: "https://wa.me/919876543210", color: "text-green-600" },
    { icon: Youtube, name: "YouTube", url: "#", color: "text-red-600" }
  ];

  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-dairy-cream/20 to-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-dairy-green/10 border border-dairy-green/20 mb-4">
            ...
            <span className="text-sm font-medium text-dairy-green">Get In Touch</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Contact Sri Krishna Dairy
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Ready to experience the finest traditional dairy products? Contact us today for orders, 
            inquiries, or to learn more about our premium khoya varieties.
          </p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div>
              ...
              {contactInfo.map((info, index) => (
                <Card key={index} className="p-6 mb-4 hover-lift border border-border card-gradient">
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-soft ${
                      info.color === 'dairy-green' ? 'dairy-gradient' : 'orange-gradient'
                    }`}>
          ...
          <Card className="overflow-hidden border border-border">
            <div className="w-full h-80 bg-gradient-to-br from-dairy-green/10 to-dairy-orange/10 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-lg font-medium text-foreground mb-2">Sri Krishna Dairy</p>
                <p className="text-muted-foreground">Main Road, Dairy Colony, City - 123456</p>
